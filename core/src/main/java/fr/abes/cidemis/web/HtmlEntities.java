...
public class HtmlEntities {
	...
	*/
	private static final HashMap<Object, Object> htmlentities_map = new HashMap();
	
	/**
	* Map to convert html entities in exteden characters.
	*/
	private static final HashMap<Object, Object> unhtmlentities_map = new HashMap();
	...
	*/
	...
	public static String unhtmlentities(String str) {
		...
		for (int i = 0; i < str.length(); ++i) {
			...
			if (ch == '&') {
				...
				if (entity.charAt(1) == '#' && entity.charAt(2) == 'x')
					iso = Integer.parseInt(entity.substring(3, entity.length() - 1), 16);
				else if (entity.charAt(1) == '#')
	...
	public static String htmlSingleQuotes(String str) {
	    String strN = str.replaceAll("[\']", "&rsquo;");
	    strN = strN.replaceAll("&#039;", "&rsquo;");
		strN = strN.replaceAll("&#145;", "&rsquo;");
		strN = strN.replaceAll("&#146;", "&rsquo;");
		return strN;
	}
	...
	public static String htmlQuotes(String str) {
	    String strN = htmlDoubleQuotes(str); // convert double quotes
		strN = htmlSingleQuotes(strN); // convert single quotes
		return strN;
	}
	...
	public static String unhtmlQuotes(String str) {
	    String strN = unhtmlDoubleQuotes(str); // convert double quotes
	    strN = unhtmlSingleQuotes(strN); // convert single quotes
		return strN;
	}
